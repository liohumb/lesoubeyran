...
let barInterval = setInterval(()=>{
    ...
    if (c === 101) {
        ...
        (0, _gsapDefault.default).to(".loading__text", {
            duration: 2.5,
            opacity: 0
        });
        (0, _gsapDefault.default).to(".loading__text-border", {
            duration: 2,
            opacity: 0
        });
        ...
        (0, _gsapDefault.default).to(".loading__counter", {
            duration: .75,
            opacity: 0
        });
        (0, _gsapDefault.default).to("header", {
            duration: 1,
            delay: 2,
            top: "0"
        });
        (0, _gsapDefault.default).to(".scroll", {
            duration: 1,
            delay: 2,
            bottom: "3rem"
        });
...
/*  MENUS  */ const $menu = document.querySelector(".menu");
...
const dispose = (scroll)=>{
    (0, _gsapDefault.default).set($content, {
        x: (i)=>{
            return i * itemWidth + scroll;
        },
        modifiers: {
            x: (x)=>{
                const s = (0, _gsapDefault.default).utils.wrap(-itemWidth, wrapWidth - itemWidth, parseInt(x));
                return `${s}px`;
            }
        }
    });
...
const render = ()=>{
    ...
    oldScrollY = y;
    (0, _gsapDefault.default).to($content, {
        skewX: -scrollSpeed * .2,
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lHRxv","9OMkf"], "9OMkf", "parcelRequiref7c5")
